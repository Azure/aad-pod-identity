...
| `mic.containerSecurityContext`            | SecurityContext for MIC container                                                                                                                                                                                                                                                                                             | `readOnlyRootFilesystem: true`                                                                           |
...
| `nmi.containerSecurityContext`            | SecurityContext for NMI container                                                                                                                                                                                                                                                                                             | `{runAsUser: 0, capabilities: {drop: [ALL], add: [DAC_READ_SEARCH, NET_ADMIN, NET_RAW]}}`                |
