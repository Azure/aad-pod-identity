...
| `podIdentityExceptions`                         | Map of pod identity exceptions to create. The map key is the `AzurePodIdentityException` name.                                                                                                                                                                                                             | `{}`                                                                                                     |
