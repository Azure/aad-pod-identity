...
| `customLabels`                            | Custom labels to add into metadata requests                                                                                                                                                                                                                                                      | `{}`                                                                                                     |
| `podMonitor.enable`                         | Determines whether a podMonitor should deployed to scrape the metrics configuration                                                                                                                                                                                                                                                      | `false`                                                                                                     |
| `podMonitor.labels`                         | Additional labels to the podMonitor                                                                                                                                                                                                                                                      | `{}`                                                                                                     |
| `podMonitor.annotations`                         | Additional annotations to the podMonitor                                                                                                                                                                                                                                                      | `{}`                                                                                                     |
| `podMonitor.interval`                         | Specifies the interval at which metrics should be scraped                                                                                                                                                                                                                                                      | `5m`                                                                                                     |
| `podMonitor.scrapeTimeout`                         | Specifies the timeout after which the scrape is ended                                                                                                                                                                                                                                                      | `30s`                                                                                                     |
