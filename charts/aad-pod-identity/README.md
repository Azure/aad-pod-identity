...
| `mic.immutableUserMSIs`                  | List of  user-defined identities that shouldn't be deleted from VM/VMSS. Note: the list should be **comma separated**                                                                                            | If not provided, default value is empty           |
