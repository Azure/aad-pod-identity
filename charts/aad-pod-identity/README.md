...
| `mic.whiteListedIdentitiesParam`         | List of whitelisted user-defined identities that shouldn't be deleted from AAD. Note: the list should be comma separated                                                                                         | If not provided, default value is empty           |
