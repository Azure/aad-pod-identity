...
func CreateInfra(namespace, registry, nmiVersion, micVersion, templateOutputPath string, old, enableScaleFeatures bool, immutableUserMSIs, nmiMode string) error {
	var err error
