...
kubectl run identityvalidator --image=mcr.microsoft.com/oss/azure/aad-pod-identity/identityvalidator:v1.7.3 --labels=aadpodidbinding=keyvault-identity -- --sleep
