...
type Config struct {
	...
	MICVersion               string `envconfig:"MIC_VERSION" default:"1.6.0"`
	NMIVersion               string `envconfig:"NMI_VERSION" default:"1.6.0"`
	Registry                 string `envconfig:"REGISTRY" default:"mcr.microsoft.com/k8s/aad-pod-identity"`
	IdentityValidatorVersion string `envconfig:"IDENTITY_VALIDATOR_VERSION" default:"1.6.0"`
